...
from main.views import (add_product_ajax, add_stock, create_new_product,
                        delete_product, get_product_json, login_user,
                        logout_user, reduce_stock, register_account, show_json,
